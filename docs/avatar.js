...
function svg(av,cat,size,o){ if(!cat) return ''; av=norm(av,cat); var blink=!!(o&&o.blink); var body=find(cat.bodies,av.body), pose=body&&body.pose==='sit'?'sit':'stand';
  ...
  out+='<path d="M 24.5 15.5 Q 27.5 14 30.5 15.2" fill="none" stroke="'+base.hair2+'" stroke-width="1" stroke-linecap="round"/><path d="M 33.5 15.2 Q 36.5 14 39.5 15.5" fill="none" stroke="'+base.hair2+'" stroke-width="1" stroke-linecap="round"/><path data-part="mouth" d="M 29.5 25.5 Q 32 27.5 34.5 25.5" fill="none" stroke="'+INK+'" stroke-width=".8" stroke-linecap="round"/>';
