...
| 1.16 | 2026-09-15 | The seven splash rulings, Dylan's answers of record, verbatim, in order: (1) "Yes please"; (2) "Not yet, need to showcase first. Or look how to use our Nous portal to use a much cheaper option to wire up like deepseek I did buy 20 dollars worth of credits for Nous to try out hermes so maybe this could be done for our website for trial for a bit? with a hard lock on Nous"; (3) "For public figures, we would need a report button and if the \"public person\" get's too many reports to support@personakind.com which should forward to dylanleeson@potionsandfamiliars.com then we can take immediate action. Or we can do what we did for Downtown Vibes and do a block for all \"major named businesses\" unless they contact us directly through support@personakind.com"; (4) "lets do it"; (5) "idk how we do that. I would want a full SWOT and KPI plan for this business metric.  I like the idea of persona T Pain playing GTA 6 with real T Pain but that is a lot."; (6) "We may need ID checks, but instead I think the bigger check is the credit/debit card that is needed for talking. If they can provide their own API key as well, then I would say they must be very smart enough to get around an 18+ prompt"; (7) "let's fix that as well". Outcomes. (1) 24 new fictional showcase personas (no real people, no brands, no care personas; every GATES cell carries a 988 crisis line), picked from one list, portraits painted locally at no cost in the house style, uploaded through the editor's own upload path working as the official account, published after Dylan ticked the official account's 18 or older confirmation through the editor (picker answer: "You tick it for me"); public personas 9 to 33, read from the public view, an anonymous REST count and Explore signed out at 1280 and 390. Jennifer edits the words live (picker answer: "Publish now, she edits live"). (2) Nous Portal is OUT for a public trial: its terms, section 10.2 (updated 2026-08-25), bar making the service available to third persons without written consent, and state no spend cap. Ruling of record from the picker: the trial runs on the DeepSeek direct API (prepaid balance, deepseek-flash) with a hard ceiling of $10 a month, an exception to the standing rule that nothing runs on the founders' credits for a free user; not built yet. (3) #86: reserved names refused at publish and rename in the database gate (verified contacts and official accounts exempt), auto-hide after 3 distinct open reports (official showcase exempt), Report in the Room; phase A applied and probed, phase B after the page is live; #87 the support mail binding. support@personakind.com forwards to the founder inbox (Cloudflare routing rule Active, a test email logged Forwarded). (4) #85: /embed/@handle/Name, a read-only card framed from any origin, framing relaxed on that route only. (5) The SWOT and KPI plan is written for Dylan and Jennifer; a real artist's persona needs that artist's consent and a license, a partnership play for later. (6) No ID checks. Talking already needs a paid pack or the user's own key (the Worker answers 402 no_credits otherwise). Stated once: a debit or prepaid card reaches minors and is not age proof, and no US statute read names a card as age verification. The signup-time 18 or older ruling stays owed. (7) Site URL is https://personakind.com and the retired GitHub Pages redirect entry is removed; a verify link with no return address now lands on personakind.com, a foreign return address falls back to it, the print portal's own address is still honoured; mds-print-portal#1 adds its sign up return address. | Dylan (founder), rulings verbatim 2026-09-15 and picker answers the same day |
